...
const UploadDialog = ({ handleToogleUploadDialog, refresh }) => {
  ...
  return (
    <div className='absolute w-[100vw] h-[100vh] z-[10] top-0 left-0 bg-transparent-dark'>
        <div className='absolute bg-white top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[80%] md:w-[40%] h-[40%] p-5 rounded-[10px]'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col w-full h-full items-center gap-3 justify-center'>
                ...
                <input type='file' name='file' id='file' required onChange={e => setFile(e.target.files[0])} className='border border-black w-[70%]' />
